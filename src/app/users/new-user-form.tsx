...
export function NewUserForm() {
  ...
  return (
    <form onSubmit={submit} className="grid gap-3 rounded-xl border border-[#e2e8e5] bg-white p-5 shadow-sm md:grid-cols-2 xl:grid-cols-[1fr_1.2fr_1fr_160px_auto]">
      ...
      <input className={inputClass} name="password" type="password" minLength={10} placeholder="Temporary password" required />
